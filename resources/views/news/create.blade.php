        ...
        <div x-data="{ openTab: 'en' }">
            ...
            <div id="myTabContent">
                <div x-show="openTab === 'en'" class="p-4 bg-transparent border border-content-border rounded-lg"
                    ...
                    <div
                        class="pb-3 mb-3 space-y-1 relative after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-current after:opacity-10">
                        <x-input-text id="en_title" name="en_title" label="Title" value="{{ old('en_title') }}"
                            description="{{ __('interfaces.maxchar_255') }}" />
                    </div>
                    <div
                        class="pb-3 mb-3 space-y-1 relative after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-current after:opacity-10">
                        <x-editor name="en_content" label="Content" value="{{ old('en_content') }}"
                            description="Write content" />
                    </div>
                    <div class="pb-3 space-y-1 relative">
                        <x-input-text id="en_keywords" name="en_keywords" value="{{ old('en_keywords') }}"
                    ...
                    <div class="pb-3 space-y-1 relative">
                        <x-input-text id="en_seo_description" name="en_seo_description"
                            value="{{ old('en_seo_description') }}" label="Description" maxlength="255"
                            description="{{ __('interfaces.maxchar_255') }}" />
                    </div>
                </div>
                <div x-show="openTab === 'ru'" class="p-4 bg-transparent border border-content-border rounded-lg"
                    ...
                    <div
                        class="pb-3 mb-3 space-y-1 relative after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-current after:opacity-10">
                        <x-input-text id="ru_title" name="ru_title" label="Title" value="{{ old('ru_title') }}"
                            description="{{ __('interfaces.maxchar_255') }}" />
                    </div>
                    <div
                        class="pb-3 mb-3 space-y-1 relative after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-current after:opacity-10">
                        <x-editor name="ru_content" label="Content" value="{{ old('ru_content') }}"
                            description="Write content" />
                    </div>
                    <div class="pb-3 space-y-1 relative">
                        <x-input-text id="ru_keywords" name="ru_keywords" value="{{ old('ru_keywords') }}"
                            label="Keywords" maxlength="255" description="{{ __('interfaces.maxchar_255') }}" />
                    </div>
                    <div class="pb-3 space-y-1 relative">
                        <x-input-text id="ru_seo_description" name="ru_seo_description"
                            value="{{ old('ru_seo_description') }}" label="Description" maxlength="255"
                            description="{{ __('interfaces.maxchar_255') }}" />
                    </div>
                </div>
                <div x-show="openTab === 'pl'" class="p-4 bg-transparent border border-content-border rounded-lg"
                    ...
                    <div
                        class="pb-3 mb-3 space-y-1 relative after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-current after:opacity-10">
                        <x-input-text id="pl_title" name="pl_title" label="Title" value="{{ old('pl_title') }}"
                            description="{{ __('interfaces.maxchar_255') }}" />
                    </div>
                    <div
                        class="pb-3 mb-3 space-y-1 relative after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-current after:opacity-10">
                        <x-editor name="pl_content" label="Content" value="{{ old('pl_content') }}"
                            description="Write content" />
                    </div>
                    <div class="pb-3 space-y-1 relative">
                        <x-input-text id="pl_keywords" name="pl_keywords" value="{{ old('pl_keywords') }}"
                            label="Keywords" maxlength="255" description="{{ __('interfaces.maxchar_255') }}" />
                    </div>
                    <div class="pb-3 space-y-1 relative">
                        <x-input-text id="pl_seo_description" name="pl_seo_description"
                            value="{{ old('pl_seo_description') }}" label="Description" maxlength="255"
                            description="{{ __('interfaces.maxchar_255') }}" />
                    </div>
                </div>
            </div>
