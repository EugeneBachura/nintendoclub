                ...
                <div class="">
                    <div class="flex flex-col py-6">
                        @foreach ($transactions as $transaction)
                            ...
                            @endphp
                            <div
                                class="w-full relative p-4 pb-5 pt-3 flex flex-col justify-between border-b border-content_text border-opacity-25">
                                        ...
                                        <div class="flex sm:justify-between items-center justify-end sm:mt-0 -mt-5">
                                            <span class="text-lg font-bold">
                                                <x-icon-with-text icon="{{ $transaction->currency }}"
                                                    tooltip="{{ __('profiles.' . $transaction->currency) }}">
                                                    {{ floor($transaction->price) }}
                                                </x-icon-with-text>
                                            </span>
                                            <div
                                                class="flex items-center flex-1 justify-end absolute bottom-2 right-3 opacity-50">
