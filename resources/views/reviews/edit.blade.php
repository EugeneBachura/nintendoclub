<x-app-layout>
    ...
    <form method="POST" id="reviewEditForm"
        action="{{ route('review.updateForAdmin', ['gameId' => $review->game_id, 'id' => $review->id]) }}"
        ...
        <div class="pb-3 mb-3 space-y-1 relative">
            <x-input-text id="status_text" name="status_text" required label="Message for user" maxlength="255"
                value="{{ old('status_text', $review->status_text) }}"
        ...
        <div class="pb-3 mb-3 space-y-1 relative">
            <x-input-text id="money" name="money" label="Awards" maxlength="4"
                value="{{ old('money', null) }}" />
        </div>
        ...
        <div
            ...
            @endphp
            <x-select name="language" label="Language" :options="$languagesOptions" description="Choose a language" required
